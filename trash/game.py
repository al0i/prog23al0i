...
background = pygame.image.load('morroAzul.jpg')
...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y, nome_imagem, nome):
        ...
        self.image = pygame.Surface((504/3, 376/3))#pygame.image.load(arquivo_imagem)
        self.image2 = pygame.image.load(arquivo_imagem)
        self.rect = self.image.get_rect(topleft=(x, y))
        self.nome = nome

        self.imageWidth = 504/3
        self.imageHeight = 376/3
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, x, y, width, height, nome_imagem):
        ...
        ##################
        arquivo_banana = os.path.join(caminho, nome_imagem)
        #self.image = pygame.image.load(arquivo_banana)
        self.imageWidth = 1086/15
        self.imageHeight = 1085/15
        #self.image = pygame.transform.scale(self.image, (self.imageWidth,self.imageHeight))
        ###############
...
for i in range(20):
    ...
    obstacleGroup.add(Obstacle(mx, my, 30, 30, 'banana.png'))
    
#o1 = Obstacle(50, 400, 10, 20)
#obsGroup.add(o1)

x = 640
y = windowHeight-376/3



sprites = pygame.sprite.Group()
player = Player(x, y, 'manke.png', 'macacao007')
sprites.add(player)
